      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="lg:text-center mb-10 md:mb-20">
          ...
          <p className="mt-4 max-w-2xl text-l text-gray-600 lg:mx-auto">
            Ви можете зробити замовлення як забажаєте, використовуючи онлайн
            форму, за номером телефону чи мессенджером.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md">
              <h3 className="text-4xl font-bold bg-clip-text bg-gradient-to-br text-transparent from-blue-600 to-blue-400">
                Контакти
              </h3>
