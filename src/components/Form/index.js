  ...
  const _handleSubmit = e => {
    fetch(url, {
      ...
      .then(data => {
        ...
        typeof window !== "undefined" && window.gtag("event", "form-click", 'submit')
      })
      .catch(err => {
        console.error(err)
      ...
      >
        <div className="shadow-md overflow-hidden rounded-lg">
          <div className="px-4 py-5 bg-white sm:p-6">
            <h3 className="text-3xl md:text-4xl font-medium leading-6 pb-1 bg-clip-text bg-gradient-to-br text-transparent from-blue-600 to-blue-400">
              Онлайн замовлення
            </h3>
